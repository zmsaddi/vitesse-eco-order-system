...
| الفواتير (عرض) | ✅ | ✅ | ✅ | 👁 (خاصتي) | 👁 | ❌ |
| إلغاء فاتورة | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ |
| إصدار Avoir (Phase 4.5 — `POST /api/v1/invoices/[id]/avoir`) | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ |
| الصندوق (عرض الكل) | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ |
...
| توزيع الأرباح (عرض) | ✅ | ✅ | 👁 | ❌ | ❌ | ❌ |
| عمولتي (`/my-bonus`) | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ |
| عمولات الكل (`GET /api/v1/bonuses`) | ✅ | ✅ | ❌ (Phase 4.4 — منع تسرُّب فِرق البائعين) | خاصتي فقط (auto-forced) | خاصتي فقط (auto-forced) | ❌ |
